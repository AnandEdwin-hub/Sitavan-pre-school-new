                    ...
                    <td className="px-6 py-3 text-right">
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="Very Late">Very Late (LL)</SelectItem>
                          <SelectItem value="Absent">Absent (A)</SelectItem>
                          <SelectItem value="Sick">Sick (S)</SelectItem>
                          <SelectItem value="Half Day">Half Day (HD)</SelectItem>
                          <SelectItem value="Holiday">Holiday (H)</SelectItem>
                          <SelectItem value="Weekly Holiday">Weekly Holiday (W)</SelectItem>
                          <SelectItem value="Forced Closure">Forced Closure (FC)</SelectItem>
                        </SelectContent>
                      </Select>
                    </td>
                  </tr>
