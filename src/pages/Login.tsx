    ...
    <div className="min-h-[100dvh] flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-sidebar rounded-t-3xl pt-10 pb-12 px-6 flex flex-col items-center">
          <div className="w-24 h-24 rounded-full bg-card flex items-center justify-center shadow-md mb-4 overflow-hidden">
            <img src="/logo.png" alt="Sitavan Pre-School" className="w-full h-full object-contain scale-125" />
          </div>
